...
class FundraiserController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $fundraiser_details = Fundraiser::with('categories','members','comments','repliedMembers')->find($id);
        $replied_member_details = Comment::with('repliedMembers')->first();
        ...
        return view('ui.pages.campaigns.campaign_page')->with('get_fundraiser',$fundraiser_details)->with('related_fundraisers',$related_fundraisers)->with('replied_member_details',$replied_member_details);
    }
