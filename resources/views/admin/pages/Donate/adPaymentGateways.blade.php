        ...
        <div class="col-lg-3 col-3 ">
            <div class="small-box paymentContainerBox">
                <div class="inner  text-center">
                    ...
                    <div class=" ">
                        <a href="../siteImages/paymentGateways/{{$paymentGatewaysBox->gateway_photo}}" data-fancybox>
                            <img src="../siteImages/paymentGateways/{{$paymentGatewaysBox->gateway_photo}}" class="paymentContainerBoxImg" />
                        </a>
                    ...
                    <div>Details</div>
                    <div class="myBadgey">Rate: <span class="amountTextColor"> {{$paymentGatewaysBox->rate}}</span> </div><br>
                    <div class="myBadgey">Min Limit: <span class="amountTextColor">{{$paymentGatewaysBox->min_limit}}</span> </div><br>
                    <div class="myBadgey">Max Limit: <span class="amountTextColor">{{$paymentGatewaysBox->max_limit}}</span> </div><br>
                    <div class="myBadgey">Charge: <span class="amountTextColor"> {{$paymentGatewaysBox->charge}} %</span> </div><br>
