    ...
    <div class="row ">
        <div class="col-lg-12 col-12 d-flex">
            ...
            <div class=" ml-auto d-flex rightSideElements">
                ...
                <div>
                    <button type="button" class=" searchButton whiteText  backgroundCerulean  font-weight-bold btn searchFormButton"> Search Log</button>
                </div>
                <div>
                </div>
            </div>
                ...
                <table class="table table-striped table-borderless  tableSmallText1">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="spaceForManage">Status</th>
                        </tr>
                    </thead>
...
<script src="{{ url('adminAssets/js/WithdrawSystem/adWithdrawLog.js') }}"></script>
