...
<section class="forgot" style="margin-top: 115px">
        <div>
            <div class="forgot_right">
                ...
                @endif
                <form class="forgot_form" style="width: 60%" action="{{url('/verify-token')}}" method="post">
                @csrf    
                    <div class="input-icons">
                        <i class="fas fa-key"></i>
                        <input class="input-field" type="text" name="token" placeholder="Enter the Token here" />
                    </div>
