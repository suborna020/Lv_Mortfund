            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="card border-0 " style=" box-shadow: 0 2px 4px 0 #e6e6e6, 0 2px 4px 0 #e6e6e6">
                        <h5 style="background-color: #adb5bd !important; color: #fff;"
                            class="card-header font-weight-bold text-center ">
...
​
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button type="submit" 
                                        ...
                                        class="btn" type="button" data-toggle="modal" data-target="#exampleModal"><i
                                            class="fas fa-check mr-2"></i>Confirm
                                    </button>
                                </div>
                            </div>
​
                        ...
                        <div class="card-body px-0 py-3">
                            <div class="container-fluid">
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button type="submit" id="card-button" type="submit" data-secret="{{ $intent }}"
                                        style="background-color: #f8800b; padding: 5px 20px; color: #fff; font-weight: 500; "
                                        class="btn" type="button" data-toggle="modal" data-target="#exampleModal"><i
                                            class="fas fa-check mr-2"></i>Confirm
                                    </button>
