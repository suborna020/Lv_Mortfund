        ...
        <div class="container adjust-container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <hr>
                    <form action="/updateFundraiser/{{$get_fundraiser->id}}" class="" method="POST" enctype="multipart/form-data">
                      @csrf
                        ...
                        <input type="text" class="form-control" name="title" value="{{$get_fundraiser->title}}">
                        <label>Enter Benificiary Name</label>
                        <input type="text" class="form-control" name="benificiary_name" value="{{$get_fundraiser->benificiary_name}}">
                        <label>Enter The Amount Needed in USD</label>
                        <input type="text" class="form-control" name="needed_amount" value="{{$get_fundraiser->needed_amount}}">
                        <label>Deadline</label>
                        <input type="date" class="form-control" name="deadline" value="{{$get_fundraiser->deadline}}">
                        <label>Write the story behind the reason of creating the campaign</label>
                        <textarea id="" name="story" class="form-control">{{$get_fundraiser->story}}</textarea>
