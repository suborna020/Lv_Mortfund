...
<form method="POST" action="{{ route('reve.pay') }}" id="paymentForm">
    {{ csrf_field() }}
    ...
    <input type="hidden" name="email" value="saqlainsagor33334@gmail.com" /> <!-- Replace the value with your customer email -->
