...
$(icons).each(function (index) {
    var itemtemp = `<i class="${icons[index].icon}" style="margin : 10px" aria-hidden="true" onClick='selectedIconFunction("${icons[index].icon}")'></i>`;
    $(".iconPickerPlace").append(itemtemp);
});
const selectedIconFunction = (iconText) => {
    
    $(".singleItem").val(iconText);
